...
Dans notre étude comparative des différents modèles de synchronisation \cf{def:synchro-synthese}, nous avons justifié que ce modèle de synchronisation est adapté à l'ensemble des contextes d'utilisation qui étaient jusqu'à lors exclusifs soit au modèle de synchronisation par états, soit par opérations.
