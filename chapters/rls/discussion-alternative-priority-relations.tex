      ...
      \begin{minipage}{\linewidth}
          ...
          \resizebox{\linewidth}{!}{
            \begin{tikzpicture}
              ...
              \draw[->, thick] (a-initial) --  (a-ren-a1) -- (a-recv-ren-b7) --  (a-ren-a8) -- (a-ellipse-debut) (a-ellipse-fin) -- (a-ren-a100) -- (a-recv-ren-c1) -- (a-final);
              ...
              \path
                  ...
                  +(0:7) node[point, label=below:{$\trm{ren}(\betterepoch{A1},B,7)$}] (b-ren-b7) {}
                  +(0:13) node (b-ellipse-debut) {}
                  +(0:15) node (b-ellipse-fin) {}
                  +(0:21) node (b-final) {};

              \draw[dotted] (b) -- (b-initial) (b-ellipse-debut) -- (b-ellipse-fin) (b-final) -- (b-end);
              \draw[->, thick] (b-initial) --  (b-recv-ren-a1) -- (b-ren-b7) -- (b-ellipse-debut) (b-ellipse-fin) -- (b-final);
