...
Dans cet exemple, le noeud B insère un nouvel élément "L", lui assigne l'identifiant \id{i}{B1}{0}\id{m}{B2}{0} et diffuse cette modification, de manière concurrente à l'opération $\trm{rename}$ décrite dans la \autoref{fig:concurrent-insert-rename-inconsistent}.
