...
\begin{figure}[!ht]
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
        ...
        \newcommand\nodee[1]{
            node[letter, fill=\colorblockone, label=#1:{$\coloridone\betterid{i}{B0}{0}\betterid{f}{A0}{0}$}] {E}
        }
        \newcommand\nodelo[1]{
            node[block, label=#1:{$\betterid{i}{B0}{1..2}$}] {LO}
        }
        \newcommand\renhelo[1]{
            node[block, fill=\colorblocktwo, label=#1:{$\coloridtwo\betterid{i}{A1}{0..3}$}] {HELO}
        }
        \newcommand\nodel[1]{
            node[letter, fill=\colorblockthree, label=#1:{$\coloridthree\betterid{i}{B0}{0}\betterid{m}{B1}{0}$}] {L}
        }
        \newcommand\crossl[1]{
            node[letter, cross, fill=\colorblockthree, label=#1:{$\coloridthree\betterid{i}{B0}{0}\betterid{m}{B1}{0}$}] {L}
        }
        ...
        \path
            ...
            +(0:8) node[point, label=170:{$\trm{ins}(E \prec L \prec O)$}, label={[xshift=45pt]10:{$\trm{ins}({\coloridthree\betterid{i}{B0}{0}\betterid{m}{B1}{0}},L)$}}] (b-ins-l) {}
            +(0:18) node (b-final) {};
...
\begin{figure}[!ht]
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
        ...
        \newcommand\renhe[1]{
            node[block, fill=\colorblocktwo, label=#1:{\coloridtwo$\betterid{i}{A1}{0..1}$}] {HE}
        }
        \newcommand\renl[1]{
            node[letter, fill=\colorblockfour, label=#1:{\coloridfour$\betterid{i}{A1}{1}\betterid{i}{B0}{0}\betterid{m}{B1}{0}$}] {L}
        }
        \newcommand\renlo[1]{
            node[block, fill=\colorblocktwo, label=#1:{\coloridtwo$\betterid{i}{A1}{2..3}$}] {LO}
        }
        ...
        \path
            ...
            +(0:20) node (b-end) {}
            +(0:2) node[point] (b-initial) {}
            +(0:8) node[point, label=170:{$\trm{ins}(E \prec L \prec O)$}, label={[xshift=45pt]10:{$\trm{ins}(\betterepoch{0}, {\coloridthree\betterid{i}{B0}{0}\betterid{m}{B1}{0}},L)$}}] (b-ins-l) {}
            +(0:18) node (b-final) {};
