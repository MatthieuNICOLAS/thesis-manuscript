...
Cet algorithme recherche le prédecesseur de l'identifiant donné (\id{i}{B1}{0}\id{m}{B2}{0}) dans l'ancien état, \ie l'identifiant maximal présent dans l'ancien état et qui est inférieur à l'identifiant donné (ligne \ref{alg:renameId-find-predecessor})\footnote{Notons que l'ancien état est un tableau trié d'identifiants, il est donc possible d'effectuer une recherche dichotomique pour trouver efficacement le prédecesseur}.
