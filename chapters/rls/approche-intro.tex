Nous proposons un nouveau \ac{CRDT} pour le type \emph{Sequence} à identifiants densément ordonnés et à granularité : RenamableLogootSplit \cite{2020-rls-papoc-nicolas,2022-rls-tpds-nicolas}.
