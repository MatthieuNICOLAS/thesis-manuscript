  ...
  \subfloat[Choix du nouvel identifiant pour le premier élément]{
      \begin{minipage}{\linewidth}
          ...
          \begin{tikzpicture}
            ...
            \newcommand\renh[1]{
                node[letter, fill=\colorblocktwo, label=#1:{$\coloridtwo\betterid{i}{A1}{0}$}] {H}
            }
  ...
  \subfloat[Choix des nouveaux identifiants pour les éléments restants]{
      \begin{minipage}{\linewidth}
          ...
          \begin{tikzpicture}
            ...
            \newcommand\rene[1]{
                node[letter, fill=\colorblocktwo, label=#1:{$\coloridtwo\betterid{i}{A1}{1}$}] {E}
            }
            \newcommand\renl[1]{
                node[letter, fill=\colorblocktwo, label=#1:{$\coloridtwo\betterid{i}{A1}{2}$}] {L}
            }
            \newcommand\reno[1]{
                node[letter, fill=\colorblocktwo, label=#1:{$\coloridtwo\betterid{i}{A1}{3}$}] {O}
            }
