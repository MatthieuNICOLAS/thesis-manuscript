...
\input{chapters/rls/concurrent-rename-ops-conflicts}

\subsection{Relation de priorité entre renommages}
\input{chapters/rls/concurrent-rename-ops-priority}

\subsection{Algorithme d'annulation de l'opération de renommage}
\input{chapters/rls/concurrent-rename-ops-revert-rename}

% \subsection{Processus d'intégration d'une opération}
% \input{chapters/rls/concurrent-rename-ops-full-alg}

\section{Mécanisme de \acl{GC} des anciens états obsolètes}
\input{chapters/rls/concurrent-rename-ops-gc}

\section{Validation}
\label{sec:evaluation}

\input{chapters/rls/validation-intro}

\subsection{Complexité en temps des opérations}
\input{chapters/rls/validation-time-complexity}

\subsection{Expérimentations}
\input{chapters/rls/validation-experimentations-intro}

\subsubsection{Scénario d'expérimentation}
\input{chapters/rls/validation-experimentations-scenario}

\subsubsection{Implémentation des simulations}
\input{chapters/rls/validation-experimentations-implem}

\subsection{Résultats}
\input{chapters/rls/validation-results-intro}

\subsubsection{Convergence}
\input{chapters/rls/validation-results-convergence}

\subsubsection{Consommation mémoire}
\input{chapters/rls/validation-results-memory-overhead}

\subsubsection{Temps d'intégration des opérations d'insertion et de suppression}
\input{chapters/rls/validation-results-integration-time-standard-ops}

\subsubsection{Temps d'intégration de l'opération de renommage}
\input{chapters/rls/validation-results-integration-time-rename-ops}

\subsubsection{Temps pour rejouer le journal des opérations}
\input{chapters/rls/validation-results-time-replay-log}

\subsubsection{Impact de la fréquence de l'opération de renommage sur les performances}
\input{chapters/rls/validation-results-rename-ops-frequency}
...
\input{chapters/rls/discussion-strategies-rename-ops}

\subsection{Stockage des états précédents sur disque}
\label{sec:offloading-former-states}
\input{chapters/rls/discussion-offload-former-states}

\subsection{Compression et limitation de la taille de l'opération de renommage}
\label{sec:compression-rename}
\input{chapters/rls/discussion-rename-op-compression}

\subsection{Définition de relations de priorité pour minimiser les traitements}
\label{sec:alt-priority-relation}
\input{chapters/rls/discussion-alternative-priority-relations}

\subsection{Report de la transition vers la nouvelle époque cible}
\label{sec:report-transition-to-target-epoch}
\input{chapters/rls/discussion-delay-transition-to-epoch}
...
\input{chapters/rls/discussion-rename-op-as-snapshot}
...
\input{chapters/rls/discussion-log-based-implem}
