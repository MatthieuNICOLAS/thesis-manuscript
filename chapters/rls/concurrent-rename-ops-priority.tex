      ...
      \begin{minipage}{\linewidth}
          ...
          \begin{tikzpicture}
            \path
                ...
                +(0:16) node (a-end) {}
                +(0:2) node (a-initial) {}
                +(0:4) node[point, label=above:{$\trm{ren}(\betterepoch{0}, A,1)$}] (a-ren-a1) {}
                +(0:14) node (a-final) {};
            ...
            \path
                ...
                +(0:16) node (b-end) {}
                +(0:2) node (b-initial) {}
                +(0:4) node[point, label=below:{$\trm{ren}(\betterepoch{0},B,2)$}] (b-ren-b2) {}
                +(0:12) node[point, label=below:{$\trm{ren}(\betterepoch{B2},B,7)$}] (b-ren-b7) {}
                +(0:14) node (b-final) {};

            \draw[dotted] (b) -- (b-initial) (b-final) -- (b-end);
            \draw[->, thick] (b-initial) -- (b-ren-b2) -- (b-ren-b7) -- (b-final);
            ...
            \path
                ...
                +(0:10) node[point, label=below:{$\trm{ren}(\betterepoch{A1},C,6)$}] (c-ren-c6) {}
                +(0:14) node (c-final) {};

            \draw[dotted] (c) -- (c-initial) (c-final) -- (c-end);
            \draw[->, thick] (c-initial) -- (c-recv-ren-a1) -- (c-ren-c6) -- (c-final);
...
Initialement, le noeud A génère une opération $\trm{rename}$ qui introduit l'époque \epoch{A1}.
Cette opération est livrée au noeud C, qui génère ensuite sa propre opération $\trm{rename}$ qui introduit l'époque \epoch{C6}.
De manière concurrente à ces opérations, le noeud B génère deux opérations $\trm{rename}$, introduisant \epoch{B2} et \epoch{B7}.
