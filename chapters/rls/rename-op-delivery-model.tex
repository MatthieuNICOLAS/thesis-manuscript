...
\begin{figure}[!ht]
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
        ...
        \newcommand\renwold[1]{
            node[block, fill=\colorblocktwo, label=#1:{\coloridtwo$\betterid{i}{A1}{0..3}$}] {WOLD}
        }
        \newcommand\renwo[1]{
            node[block, fill=\colorblocktwo, label=#1:{\coloridtwo$\betterid{i}{A1}{0..1}$}] {WO}
        }
        \newcommand\renr[1]{
            node[letter, fill=\colorblockfour, label=#1:{\coloridfour$\betterid{i}{A1}{1}\betterid{f}{A2}{0}$}] {R}
        }
        \newcommand\renld[1]{
            node[block, fill=\colorblocktwo, label=#1:{\coloridtwo$\betterid{i}{A1}{2..3}$}] {LD}
        }
        ...
        \path
            ...
            +(0:16) node[point, label=-170:{$\trm{ins}(O \prec R \prec L)$}, label={[xshift=20pt]-10:{$\trm{ins}(\betterepoch{A1}, {\coloridfour\betterid{i}{A1}{1}\betterid{f}{A2}{0}},R)$}}] (a-ins-r) {}
            +(0:22) node (a-final) {};
...
\begin{figure}[!ht]
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
      ...
      \newcommand\noder[1]{
          node[letter, fill=\colorblockone, label=#1:{\coloridone$\betterid{m}{A1}{0}$}] {R}
      }
      \newcommand\renworld[1]{
          node[block, fill=\colorblocktwo, label=#1:{\coloridtwo$\betterid{i}{A2}{0..3}$}] {WORLD}
      }
      \newcommand\renwo[1]{
      ...
      \path
          ...
          +(0:32) node (a-end) {}
          +(0:2) node[point] (a-initial) {}
          +(0:9) node[point, label=-170:{$\trm{ins}(O \prec R \prec L)$}, label={[xshift=100pt]-10:{$\trm{ins}(\betterepoch{A1}, {\coloridone\betterid{m}{A1}{0}}, R)$}}] (a-ins-r) {}
...
Comme l'époque de génération de l'opération $\trm{insert}$ (\epoch{0}) est différente de celle de son état courant (\epoch{A2}), le noeud B utilise \textsc{renameId} pour renommer l'identifiant avant de l'insérer.
