...
Cette étape correspond à fusionner $p$ vecteurs de version contenant $p$ entrées, elle s'exécute donc en \bigO{p^2} instructions.
...
\begin{table}[!ht]
  ...
  \resizebox{.7\columnwidth}{!}{
      \begin{tabular}{lc}
          ...
          Étape & Temps \\
          \midrule
          \emph{calculer le vecteur de version des opérations causalement stables} & \bigO{p^2} \\
