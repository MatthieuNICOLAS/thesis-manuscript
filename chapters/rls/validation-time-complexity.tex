...
% Par souci de cohérence avec notre évaluation expérimentale décrite en \autoref{sec:evaluation-results}, nous analysons ici les complexités en temps de notre implémentation.
Nous distinguons donc pour chaque opération deux complexités : une complexité pour l'intégration de l'opération \emph{locale}, une pour l'intégration de l'opération \emph{distante}.
