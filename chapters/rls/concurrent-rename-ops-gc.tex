      ...
      \begin{minipage}{\linewidth}
          ...
          \begin{tikzpicture}
            \path
                ...
                +(0:14) node (a-end) {}
                +(0:1) node (a-initial) {}
                +(0:3) node[point, label=above:{$\trm{ren}(\betterepoch{0}, A,1)$}] (a-ren-a1) {}
                +(0:7) node[point, label=above:{$\trm{ren}(\betterepoch{A1}, A,8)$}] (a-ren-a8) {}
                +(0:9) node[point] (a-recv-ren-b2) {}
                +(0:11) node[point, label=above:{$\trm{ren}(\betterepoch{B2}, A,9)$}] (a-ren-a9) {}
                +(0:13) node (a-final) {};

            \draw[dotted] (a) -- (a-initial) (a-final) -- (a-end);
            \draw[->, thick] (a-initial) --  (a-ren-a1) --  (a-ren-a8) -- (a-recv-ren-b2) --  (a-ren-a9) -- (a-final);
            ...
            \path
                ...
                +(0:14) node (b-end) {}
                +(0:1) node (b-initial) {}
                +(0:3) node[point, label=below:{$\trm{ren}(\betterepoch{0},B,2)$}] (b-ren-b2) {}
                +(0:5) node[point] (b-recv-ren-a1) {}
                +(0:11) node[point, label=below:{$\trm{ren}(\betterepoch{B2},B,7)$}] (b-ren-b7) {}
                +(0:13) node (b-final) {};

            \draw[dotted] (b) -- (b-initial) (b-final) -- (b-end);
            \draw[->, thick] (b-initial) -- (b-ren-b2) -- (b-recv-ren-a1) -- (b-ren-b7) -- (b-final);

            \draw[->, dashed, shorten >= 1] (a-ren-a1) -- (b-recv-ren-a1);
...
Le noeud A génère tout d'abord une opération $\trm{rename}$ vers \epoch{A1} et ensuite une opération $\trm{rename}$ vers \epoch{A8}.
Il reçoit ensuite une opération $\trm{rename}$ du noeud B qui introduit \epoch{B2}.
...
De manière concurrente, le noeud B génère l'opération $\trm{rename}$ vers \epoch{B2}.
Il reçoit ensuite l'opération $\trm{rename}$ vers \epoch{A1} du noeud A.
...
À la livraison de l'opération $\trm{rename}$ introduisant l'époque \epoch{B2} au noeud A, cette opération devient causalement stable.
...
À l'inverse, la livraison de l'opération $\trm{rename}$ vers \epoch{A1} au noeud B ne lui permet pas de supprimer la moindre métadonnée.
