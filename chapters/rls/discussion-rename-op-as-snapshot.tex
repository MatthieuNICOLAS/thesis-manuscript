...
Notons que les données contenues dans l'opération $\trm{rename}$ telle que nous l'avons définie précédemment \cf{def:rename-op} sont insuffisantes pour cette utilisation.
