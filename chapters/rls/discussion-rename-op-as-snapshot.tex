...
Les approches présentées dans \cite{2002-log-compression-op-based-vcs-shen-sun, 2006-these-claudia} consistent à remplacer un sous-ensemble des opérations du journal par une opération équivalente, par exemple en aggrégeant les opérations \emph{insert} adjacentes.
...
Nous définissons donc de la manière suivante l'opération \emph{rename} enrichie compatible avec ce mécanisme de compression du journal :
...
\indent\withmathbreak{
  \begin{definition}[rename enrichie]
    ...
    \begin{itemize}
      ...
      \item $\trm{versionVector}$ est le vecteur de version représentant l'ancien état du noeud au moment du renommage.
