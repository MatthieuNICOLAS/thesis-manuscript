...
\begin{enumerate}
  ...
  \item Identifier les opérations concurrentes à l'opération \emph{rename} présentes dans son journal des opérations.
  \item Transformer et intégrer successivement les opérations concurrentes à l'opération \emph{rename} à ce nouvel état.
\end{enumerate}

Cet algorithme est équivalent à ré-ordonner le journal des opérations de façon à intégrer les opérations précédant l'opération \emph{rename}, puis à intégrer l'opération \emph{rename} elle-même, puis à intégrer les opérations concurrentes à cette dernière.
...
La version présentée ici effectue une transformation pour chaque opération concurrente à l'opération \emph{rename} à intégrer présente dans le journal des opérations.
...
Lors du traitement d'une nouvelle opération \emph{rename}, les noeuds peuvent alors parcourir ce journal réduit à la recherche des opérations concurrentes.
