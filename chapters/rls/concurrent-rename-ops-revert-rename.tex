...
\begin{figure}[!ht]
      ...
      \begin{minipage}{\linewidth}
        ...
        \resizebox{\columnwidth}{!}{
            \begin{tikzpicture}
                ...
                \newcommand\renx[1]{
                    node[letter, fill=\colorblocksix, label=#1:{$\betterid{g}{C3}{2}\betterid{e}{C4}{0}$}] {X}
                }
                \newcommand\reny[1]{
                    node[letter, fill=\colorblocksix, label=#1:{$\betterid{g}{C3}{2}\betterid{u}{C5}{0}$}] {Y}
                }
                \newcommand\nodel[1]{
                    node[letter, fill=\colorblockthree, label=#1:{\coloridthree$\betterid{t}{D3}{0}$}] {L}
                }
                ...
                \path
                    ...
                    +(0:17)  node[point, label=-170:{$\trm{ins}(L \prec Y \prec D)$}, label={[xshift=0pt]-10:{$\trm{ins}(\betterepoch{C3}, \betterid{g}{C3}{2}\betterid{u}{C5}{0},Y)$}}] (c-ins-y) {}
                    +(0:22) node (c-final) {};
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            ...
            \newcommand\nodex[1]{
                node[letter, fill=\colorblocksix, label=#1:{$\betterid{n}{C2}{0}\bott\betterid{e}{C4}{0}$}] {X}
            }
            \newcommand\nodey[1]{
                node[letter, fill=\colorblocksix, label=#1:{$\betterid{u}{C5}{0}$}] {Y}
            }
            \newcommand\rendwor[1]{
                node[block, fill=\colorblockfive, label=#1:{\coloridfive$\betterid{k}{D4}{0..2}$}] {WOR}
            }
            \newcommand\rendx[1]{
                node[letter, fill=\colorblocksix, label=#1:{$\betterid{k}{D4}{2}\bott\betterid{e}{C4}{0}$}] {X}
            }
            \newcommand\rendl[1]{
                node[letter, fill=\colorblockfive, label=#1:{\coloridfive$\betterid{k}{D4}{3}$}] {L}
            }
            \newcommand\rendy[1]{
                node[letter, fill=\colorblocksix, label=#1:{$\betterid{k}{D4}{3}\betterid{u}{C5}{0}$}] {Y}
            }
            \newcommand\rendd[1]{
