...
Cette opération réassigne à chaque élément un nouvel identifiant à partir de l'identifiant du premier élément de la séquence (\id{i}{B1}{0}), de l'identifiant du noeud (\textbf{B}) et de son numéro de séquence courant (3).
