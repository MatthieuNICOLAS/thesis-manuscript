...
Pour répondre à cette problématique, nous proposons dans cette thèse RenamableLogootSplit \cite{2018-rls-middleware-nicolas,2020-rls-papoc-nicolas,2022-rls-tpds-nicolas}, un nouveau \ac{CRDT} pour le type Séquence.
...
Nous avons notamment implémenté plusieurs travaux de la littérature : le \ac{CRDT} pour le type Séquence LogootSplit \cite{2013-logootsplit} et le protocole d'appartenance au réseau SWIM \cite{swim2002}.
À l'issue de nos travaux sur la réduction du surcoût des \acp{CRDT} pour le type Séquence dans les systèmes pair-à-pair, nous avons aussi implémenté notre proposition : le \ac{CRDT} RenamableLogootSplit \cite{2022-rls-tpds-nicolas}.
