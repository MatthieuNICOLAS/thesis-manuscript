...
Pour cela, la plupart de ces systèmes adoptent une architecture décentralisée, que nous illustrons par la \autoref{fig:decentralised-system}.
...
\begin{figure}[!ht]
  ...
  \caption[Représentation d'une architecture décentralisée]{Représentation d'une architecture décentralisée \cite{1964-distributed-communications-networks-baran}}
...
\begin{figure}[!ht]
  ...
  \caption[Représentation d'une architecture distribuée]{Représentation d'une architecture distribuée \cite{1964-distributed-communications-networks-baran}}
...
\begin{figure}[!ht]
  ...
  \caption[Évaluation d'applications et de technologies vis-à-vis des 7 propriétés visées par les applications \aclp{LFS}]{
...
Cependant, de nombreuses problématiques de recherche identifiées dans \cite{localfirstsoftware2019} sont encore non résolues et entravent la démocratisation des applications \ac{LFS}, notamment celles à large échelle.
...
De nouveau, le modèle du système des applications que nous visons, \ie des applications \ac{LFS} à large échelle, limitent les choix possibles concernant les mécanismes de résolution de conflits.
