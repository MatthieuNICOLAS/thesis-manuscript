...
\begin{figure}[!ht]
  ...
  \caption[Caption for lfs-comparison-apps]{
    ...
    {\color{lfsgreen} \checked}, {\color{lfsorange} \Flatsteel} et {\color{lfsred} \ding{108}} indiquent respectivement que l'application ou la technologie satisfait pleinement, partiellement ou aucunement le critère évalué.
  }
