...
\begin{definition}[Convergence forte]
  La convergence forte est une propriété de sécurité indiquant que l'ensemble des noeuds d'un système ayant observés le même ensemble de modifications obtiendront des états équivalents\footnotemark.
  \footnotetext{Nous considérons comme équivalents deux états pour lesquels chaque observateur du type de données renvoie un même résultat.}
\end{definition}
...
Malgré leur spécification différente, les \acp{CRDT} partagent la même sémantique, \ie le même comportement, et la même interface que les types séquentiels\footnotemark correspondant du point de vue des utilisateurs.
