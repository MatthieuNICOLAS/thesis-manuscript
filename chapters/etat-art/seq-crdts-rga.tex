\begin{itemize}
  ...
  \item À la différence des auteurs de WOOT, \textcite{ROH2011354} jugent le coût des tombstones trop élévé.
  ...
  \item Concernant le modèle de livraison adopté, \ac{RGA} repose sur une livraison causale des opérations.
    ...
    Néanmoins \textcite{2021-these-vic} indique que \ac{RGA} pourrait adopter le même modèle de livraison que WOOT.
  ...
  \item \textcite{2019-interleaving-anomalies-collaborative-editors-kleppmann} mettent en lumière un problème des \acp{CRDT} pour Séquence.
