...
\begin{enumerate}
  \item $\trm{ins}(s,i,elt)$, qui permet d'insérer un élément donné $e$ à un index donné $i$ dans une séquence $s$ de taille $m$.
    ...
    \begin{multline*}
      ...
      s = \langle e_0, ..., e_{i-1}, e_{i}, ..., e_{m-1} \rangle~\cdot \\
      \trm{ins}(s,i,e) = \langle e_0, ..., e_{i-1}, e, e_{i}, ..., e_{m-1}  \rangle
    \end{multline*}
  \item $\trm{rmv}(s,i)$, qui permet de retirer l'élément situé à l'index $i$ dans une séquence $s$ de taille $m$.
    ...
    \begin{multline*}
      ...
      s = \langle e_0, ..., e_{i-1}, e_{i}, e{i+1}, ..., e_{m-1} \rangle~\cdot \\
      \trm{rmv}(s,i) = \langle e_0, ..., e_{i-1}, e_{i+1}, ..., e_{m-1}  \rangle
    \end{multline*}
\end{enumerate}
...
\begin{definition}[Passage à l'échelle]
