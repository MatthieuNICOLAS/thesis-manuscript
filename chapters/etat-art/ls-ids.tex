...
\begin{enumerate}
  \item  \id{i}{A1}{1} $\lid$ \id{i}{B1}{1} car le tuple composant le premier identifiant est inférieur au tuple composant le second identifiant, \ie \id{i}{A1}{1} $\ltuple$ \id{i}{B1}{1}.
  \item \id{i}{B1}{1} $\lid$ \id{i}{B1}{1}\id{f}{A1}{1} car le premier identifiant est un préfixe du second identifiant.
\end{enumerate}
