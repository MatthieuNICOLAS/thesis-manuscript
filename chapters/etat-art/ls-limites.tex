    ...
    \begin{tikzpicture}
      ...
      \newcommand\inse[3]{
        \path
          ...
          ++(0:\widthletter) node[letter, fill=ucl2orange, label=-#3:{$\color{ucl1orange}\betterid{i}{B1}{0}\betterid{f}{A1}{0}$}] {E}
      ...
      \path
        ...
        +(0:6) node[point, label=-170:{$\trm{ins}(H \prec E \prec L)$}, label={-10:{$\trm{ins}({\color{ucl1orange}\betterid{i}{B1}{0}\betterid{f}{A1}{0}},E)$}}] (a-ins-e) {}
        +(0:10) node (a-final) {};
    ...
    \begin{tikzpicture}
      ...
      \newcommand\inso[3]{
        \path
          ...
          ++#2
          ++(0:0.5) node[block, label=#3:{$\betterid{i}{A1}{0..3}$}] {HELL}
          ++(0:1.1*\widthblock) node[letter, fill=ucl2orange, label=-#3:{$\color{ucl1orange}\betterid{m}{A2}{0}$}] {O};
      }
      ...
      \path
        ...
        +(0:14) node[point, label=-170:{$\trm{ins}(L \prec O)$}, label={-10:{$\trm{ins}({\color{ucl1orange}\betterid{m}{A2}{0}},O)$}}] (a-ins-o) {}
        +(0:18) node (a-final) {};
