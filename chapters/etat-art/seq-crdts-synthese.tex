...
Pour respecter les propriétés \ref{def:id-prop-1} et \ref{def:id-prop-2}, les \acp{CRDT} reposent généralement sur des dots \cite{2014-scalable-accurate-causality-tracking} :
\begin{definition}[Dot]
  \label{def:dot}
  Un dot est un couple $\langle \trm{nodeId}, \trm{nodeSeq} \rangle$ avec
  \begin{enumerate}
