    ...
    \begin{tikzpicture}
      \newcommand\initialstate[3]{
        \path
          #1
          ++#2
          ++(0:0.5) node[block, label=#3:{$\betterid{p}{A1}{1..4}$}] {WOLD};
      }
      ...
      \newcommand\insr[3]{
        \path
          #1
          ++#2
          ++(0:0.5) node[block, label=#3:{$\betterid{p}{A1}{1..2}$}] {WO}
          ++(0:\widthblock) node[letter, fill=ucl2orange, label=-#3:{$\color{ucl1orange}\betterid{p}{A1}{2}\betterid{m}{A2}{1}$}] {R}
          ++(0:\widthletter)  node[block, label=#3:{$\betterid{p}{A1}{3..4}$}] {LD};
      }
      ...
      \newcommand\rmvr[3]{
        \path
          ...
          ++#2
          ++(0:0.5) node[block, label=#3:{$\betterid{p}{A1}{1..2}$}] {WO}
          ++(0:\widthblock)  node[block, label=#3:{$\betterid{p}{A1}{3..4}$}] {LD};
      }
      ...
      \path
        ...
        +(0:6) node[point, label=-170:{$\trm{ins}(O \prec R \prec L)$}, label={[xshift=6em]-10:{$\trm{ins}({\color{ucl1orange}\betterid{p}{A1}{2}\betterid{m}{A2}{1}},R)$}}] (a-ins-r) {}
      ...
      \path
        ...
        +(0:14) node[point, label=170:{$\trm{rmv}(R)$}, label={[xshift=1em]10:{$\trm{rmv}({\color{ucl1orange}\betterid{p}{A1}{2}\betterid{m}{A2}{1}})$}}] (b-rmv-r) {}
