...
Afin d'ordonner les modifications effectués dans un système, la littérature repose généralement sur la relation \emph{happen-before} \cite{1978-happen-before-lamport}.
...
Cependant, la majorité des types de données proposent des opérations de modifications qui ne sont pas commutatives car de sémantiques contraires.
...
\begin{enumerate}[label=(\roman*)]
  ...
  \item Tous les noeuds ayant observés le même ensemble de modifications obtiendront des états équivalents.
    Cette propriété est connue sous le nom de \emph{cohérence forte à terme} \mnnote{TODO: Ajouter ref}.
\end{enumerate}
