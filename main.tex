...
\begin{itemize}
  ...
  \item Dans \ac{RGA}, l'intention de l'insertion est définit comme l'insertion d'un nouvel élément directement après un élément existant.
    ...
    Nommé S4Vector, ces identifiants sont de la forme suivante\footnote{Dans présentations suivantes de \ac{RGA}, utilisent horloge de Lamport \cite{1978-happen-before-lamport} plutôt} $\langle \trm{ssid},\trm{sum},\trm{ssn},\trm{seq} \rangle$ avec:
    \begin{itemize}
...
\begin{itemize}
  ...
  \item Finalement, Treedoc souffre du problème de l'entrelacement d'éléments insérés de manière concurrente, malgré ce qui est conjecturé dans \cite{2019-interleaving-anomalies-collaborative-editors-kleppmann}.
\end{itemize}
