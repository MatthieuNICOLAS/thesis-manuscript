...
\begin{itemize}
  \item Afin de garantir la cohérence du système, LogootSplit doit être associé à une couche
...
Tout d'abord, les opérations \emph{remove} doit être livrées au \ac{CRDT} après les opérations \emph{insert} correspondante.
...
Nous définissons donc le modèle de livraison suivant :
