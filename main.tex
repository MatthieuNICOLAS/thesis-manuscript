...
\mnnote{TODO: Lister propriétés de SWIM}
...
\mnnote{TODO: Ajouter que le noeud source envoie son statut et que le noeud cible l'ajoute à sa liste.}
...
Dans figure, nous représentons un réseau \ac{P2P} créé avec \ac{WebRTC} et les différents serveurs impliqués.

\mnnote{TODO: Ajouter figure architecture système pour WebRTC}
