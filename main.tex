...
À partir de ces contraintes, nous définissons le modèle de livraison suivant :

\begin{definition}[Exactly-once + Causal remove]
  TODO
\end{definition}

Dans ses travaux de thèse, \textcite{2021-these-vic} propose Dotted LogootSplit, un nouveau Sequence \ac{CRDT} basée sur les différences.
...
\begin{itemize}
  \item Plusieurs approches ont été proposées pour réduire croissance des métadonnées dans Sequence CRDT
