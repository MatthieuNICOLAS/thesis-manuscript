  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
        \path
            ...
            to ++(0:10 * \widthletter) node[epoch] (S2A-left) {\epoch{A1}}
            to ++(0:1.3 * \widthepoch) node[block, fill=mydarkblue,
                    label={below:{\color{mydarkblueid}\id{i}{A1}{0..1}} }
                        ] {HE}
            to ++(0:\widthblock) node[letter, fill=mylightblue,
    ...
    \begin{minipage}{\linewidth}
      ...
      \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            \path
                node {\textbf{C}}
                to ++(0:0.5 * \widthletter) node[epoch] (S1C-left) {\epoch{0}}
                to ++(0:1.05 * \widthoriginepoch) node[letter,
                          label={below:{\id{k}{D0}{0}} }
                              ] {W}
                to ++(0:\widthletter) node[letter,
                          label={below:{\id{n}{C0}{0}} }
                              ] {O}
                to ++(0:\widthletter) node[letter,
                          label={below:{\id{o}{D1}{0}} }
                              ] (S1C-right) {D}
                to ++(0:3 * \widthblock) node[epoch] (S2C-left) {\epoch{C1}}
                to ++(0:1.3 * \widthepoch) node[block, fill=mydarkblue,
                          label={below:{\color{mydarkblueid}\id{k}{C1}{0..2}} }
                              ] (S2C-right) {WOD}
                to ++(0:4 * \widthblock) node[epoch] (S3C-left) {\epoch{C1}}
                to ++(0:1.3 * \widthepoch) node[block, fill=mydarkblue,
                ...
                to ++(0:\widthletter) node[letter, fill=mydarkblue,
                          label={below:{\color{mydarkblueid}\id{k}{C1}{2}} }
                              ] (S3C-right) {D}
                to ++(0:3 * \widthblock) node[epoch] (S4C-left) {\epoch{C1}}
                to ++(0:1.3 * \widthepoch) node[block, fill=mydarkblue,
                          label={below:{\color{mydarkblueid}\id{k}{C1}{0..1}} }
                              ] {WO}
                ...
                to ++(0:\widthletter) node[letter, fill=mylightblue,
            ...
            \path
                to ++(270:3) node {\textbf{D}}

                to ++(0:0.5 * \widthletter) node[epoch] (S1D-left) {\epoch{0}}
                to ++(0:1.05 * \widthoriginepoch) node[letter,
                          label={below:{\id{k}{D0}{0}} }
                              ] {W}
                to ++(0:\widthletter) node[letter,
                ...
                to ++(0:3 * \widthblock) node[epoch] (S2D-left) {\epoch{0}}
                to ++(0:1.05 * \widthoriginepoch) node[letter,
                          label={below:{\id{k}{D0}{0}} }
                              ] {W}
                to ++(0:\widthletter) node[letter,
                ...
                to ++(0:\widthletter) node[letter, fill=mylightorange,
                ...
                to ++(0:4 * \widthblock) node[epoch] (S3D-left) {\epoch{D3}}
                to ++(0:1.34 * \widthepoch) node[block, fill=mydarkpurple,
    ...
    \begin{minipage}{\linewidth}
      ...
      \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            \path
                node {\textbf{C}}
                to ++(0:0.5 * \widthletter) node[epoch] (S4C-left) {\epoch{C1}}
                to ++(0:1.3 * \widthepoch) node[block, fill=mydarkblue,
                          label={below:{\color{mydarkblueid}\id{k}{C1}{0..1}} }
                              ] {WO}
                to ++(0:\widthblock) node[letter,
                ...
                to ++(0:2 * \widthblock) node[point] (between-S4C-S5C) {}
                to ++(0:3 * \widthletter) node[epoch] (S5C-left) {\epoch{0}}
                to ++(0:1.05 * \widthoriginepoch) node[letter,
                          label={below:{\id{k}{D0}{0}} }
                              ] {W}
                to ++(0:\widthletter) node[letter,
                ...
                to ++(0:2 * \widthblock) node[epoch] (S6C-left) {\epoch{D3}}
                to ++(0:1.34 * \widthepoch) node[block, fill=mydarkpurple,
            ...
            \path
                ...
                to ++(0:0.5 * \widthletter) node[epoch] (S3D-left) {\epoch{D3}}
                to ++(0:1.34 * \widthepoch) node[block, fill=mydarkpurple,
                          label={below:{\color{mydarkpurpleid}\id{k}{D3}{0..3}} }
                              ] (S3D-right) {WOLD};
...
\section{Couche éditeur de texte}
...
Pour cela, le module \texttt{Sync} ajoute un \emph{Dot} à chaque opération :
          ...
          \resizebox{\columnwidth}{!}{
            \begin{tikzpicture}
                \path
                    node {\textbf{A}}
                    to ++(0:0.5 * \widthletter) node[epoch] {\epoch{0}}
                    to ++(0:1.05 * \widthoriginepoch) node[block, label=below:{\id{p}{A0}{0..4}}] (S0A) {OGNON}
                    to ++(0:5 * \widthletter) node[epoch] (S1A-left) {\epoch{0}}
                    to ++(0:1.05* \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}]  {O}
                    to ++(0:\widthletter) node[letter, fill=mydarkorange, label=above:{\id{p}{A0}{0}\id{m}{A1}{0}}] {I}
                    to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S1A-right) {GNON}
                    to ++(0:21 * \widthletter) node[epoch] (S2A-left) {\epoch{0}}
                    to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                    to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] {GNON};
                ...
                \path
                    to ++(270:4) node {\textbf{B}}
                    to ++(0:0.5 * \widthletter) node[epoch] {\epoch{0}}
                    to ++(0:1.05 * \widthoriginepoch) node[block, label=below:{\id{p}{A0}{0..4}}] (S0B) {OGNON}
                    to ++(0:12 * \widthletter) node[epoch] (S1B-left) {\epoch{0}}
                    to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                    to ++(0:\widthletter) node[letter, fill=mydarkorange, label=above:{\id{p}{A0}{0}\id{m}{A1}{0}}] {I}
                    to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S1B-right) {GNON}
                    to ++(0:5 * \widthletter) node[epoch] (S2B-left) {\epoch{0}}
                    to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                    to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S2B-right) {GNON}
                    to ++(0:8 * \widthletter) node[epoch] (S3B-left) {\epoch{0}}
                    to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                    to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] {GNON};
    ...
    \begin{minipage}{\linewidth}
      ...
      \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            \path
                node {\textbf{A}}
                to ++(0:1) node[point, label=above:{$\langle A:5 \rangle$}] (a-start) {}
                to ++(0:2) node[draw, circle, label=above:{$\langle A:6 \rangle$}] (a-a6) {a6}
                to ++(0:8) node[point, label=above:{$\langle A:6,B:1 \rangle$}, label=below:{\emph{deliver}}] (a-b1) {}
                to ++(0:3) node (a-end) {};


            \path
                to ++(270:3) node {\textbf{B}}
                to ++(0:1) node[point, label=below:{$\langle A:5 \rangle$}] (b-start) {}
                to ++(0:5) node[point, label=below:{$\langle A:6 \rangle$}, label=above:{\emph{deliver}}] (b-a6-1) {}
                to ++(0:2) node[draw, circle, label=below:{$\langle A:6,B:1 \rangle$}] (b-b1) {b1}
                to ++(0:5) node[point, label=below:{$\langle A:6,B:1 \rangle$}, label=above:{\emph{discard}}] (b-a6-2) {}
                to ++(0:1) node (b-end) {};
          ...
          \resizebox{\columnwidth}{!}{
            \begin{tikzpicture}
              \path
                  ...
                  to ++(0:21 * \widthletter) node[epoch] (S2A-left) {\epoch{0}}
                  to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                  to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S2A-right) {GNON}
                  to ++(0:19 * \widthletter) node (A-end) {};
              ...
              \path
                  ...
                  to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                  to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S2B-right) {GNON}
                  to ++(0:29 * \widthletter) node (B-end) {};

              \path
                  to ++(270:8) node {\textbf{C}}
                  to ++(0:\widthletter) node[epoch] {\epoch{0}}
                  to ++(0:1.05 * \widthoriginepoch) node[block, label=below:{\id{p}{A0}{0..4}}] (S0C) {OGNON}
                  to ++(0:30 * \widthletter) node[point] (S1C) {}
                  to ++(0:8 * \widthletter) node[letter, label=below:{\id{p}{A0}{0}}] (S2C-left) {O}
                  to ++(0:\widthletter) node[letter, fill=mydarkorange, label=above:{\id{p}{A0}{0}\id{m}{A1}{0}}] {I}
                  to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S2C-right) {GNON}
                  to ++(0:5 * \widthletter) node[epoch] (S3C-left) {\epoch{0}}
                  to ++(0:1.05 * \widthoriginepoch) node[letter, label=below:{\id{p}{A0}{0}}] {O}
                  to ++(0:\widthletter) node[block, label=below:{\id{p}{A0}{1..4}}] (S3C-right) {GNON}
                  to ++(0:2 * \widthblock) node (C-end) {};
      ...
      \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            ...
            \path
                to ++(270:3) node {\textbf{B}}
                to ++(0:1) node[point, label=below:{$\langle A:5 \rangle$}] (b-start) {}
                to ++(0:5) node[point, label=below:{$\langle A:6 \rangle$}, label=above:{\emph{deliver}}] (b-a6) {}
                to ++(0:2) node[draw, circle, label=below:{$\langle A:6,B:1 \rangle$}] (b-b1) {b1}
                to ++(0:14) node (b-end) {};

            \path
                to ++(270:6) node {\textbf{C}}
                to ++(0:1) node[point, label=below:{$\langle A:5 \rangle$}] (c-start) {}
                to ++(0:10) node[point, label=below:{$\langle A:5 \rangle$}, label=above:{\emph{postpone}}] (c-b1-postpone) {}
                to ++(0:5) node[point, label=below:{$\langle A:6 \rangle$}, label=above:{\emph{deliver}}] (c-a6) {}
                to ++ (0:5) node[point, label=below:{$\langle A:6,B:1 \rangle$}, label=above:{\emph{deliver}}] (c-b1-deliver) {}
                to ++(0:1) node (c-end) {};
