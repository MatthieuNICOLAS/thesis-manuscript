    ...
    \begin{definition}[Relation $\lid$]
      Étant donné deux identifiants $id = t_1 \oplus t_2 \oplus ... \oplus t_n$ et $id' = t'_1 \oplus t'_2 \oplus ... \oplus t'_m$, on a :
        \[
          ...
          \begin{cases}
            n < m \wedge \forall i \in [1,n] \cdot t_i = t'_j                                   & \text{or} \\
            \exists j \leq m \cdot \forall i < j \cdot t_i = t'_i \wedge t_j \ltuple t'_j &           \\
          \end{cases}
        \]
    \end{definition}
      ...
      Étant donné deux tuples $t = \langle \trm{pos},\trm{nodeId},\trm{seq} \rangle$ et $t' = \langle \trm{pos'},\trm{nodeId'},\trm{seq'} \rangle$, on a :
        \[
          ...
          \begin{cases}
            ...
            \trm{pos} = \trm{pos'} \wedge \trm{nodeId} < \trm{nodeId'}                    & \text{or} \\
            \trm{pos} = \trm{pos'} \wedge \trm{nodeId} = \trm{nodeId'} \wedge \trm{seq} < \trm{seq'}  &           \\
          \end{cases}
        \]
    \end{definition}
