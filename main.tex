...
\begin{figure}[!ht]
  \centering
  \includegraphics[page=2, trim=7cm 3cm 4cm 2cm, clip, width=.7\linewidth]{img/mute-figures.pdf}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[page=3, trim=3cm 1cm 4cm 1cm, clip, width=.7\linewidth]{img/mute-figures.pdf}
