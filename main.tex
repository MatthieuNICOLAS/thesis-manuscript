...
Notamment, elle développe \acf{MUTE}\cite{MUTE2017}\footnote{Disponible à l'adresse : \url{https://mutehost.loria.fr}}\footnote{Code source disponible à l'adresse suivante : \url{https://github.com/coast-team/mute}}, un éditeur collaboratif \ac{P2P} temps réel chiffré de bout en bout.
...
Néanmoins, cela ne l'empêche pas de délivrer l'opération \emph{b3} à sa réception et d'obtenir la version $\langle A:7,B:4,C:1 \rangle$.
...
\begin{figure}[!ht]
  \centering
  \includegraphics[page=1, trim=7cm 3cm 4cm 2cm, clip, width=.7\linewidth]{img/mute-figures.pdf}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[page=2, trim=3cm 1cm 4cm 1cm, clip, width=.7\linewidth]{img/mute-figures.pdf}
