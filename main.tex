...
\begin{itemize}
  ...
  \item Pour ce faire, la spécification des \acp{CRDT} reposent sur la théorie des treillis :
    \begin{enumerate}[label=(\roman*)]
      ...
      \item Il existe une fonction de fusion qui, pour toute paire d'états, génère l'état minimal supérieur d'après $\leq$ aux deux états fusionnés.
...
\begin{itemize}
  \item Intéressant de noter que cette approche met en place une diffusion des modifications suivant le modèle de cohérence causale \mnnote{TODO: Ajouter ref} par nature.
