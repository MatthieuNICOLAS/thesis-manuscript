    ...
    \begin{figure}[!ht]
      ...
      \resizebox{0.2\columnwidth}{!}{
        \begin{tikzpicture}
          ...
          \path
              node[node, label=above:{$\epsilon$}] {C}
                child {
                  node[node] {A}
                    child[missing]
    ...
    \begin{figure}[!ht]
      ...
      \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            ...
            \path
              ...
              node[node] {M}
                child {
                    node[node] {H}
                      child[missing]
                      child {node[node] {E} edge from parent node[right] {1}}
          ...
          \newcommand\heml[2]{
            \path
              ...
              node[node] {M}
                ...
                child {
                  node[node] {L} edge from parent node[right] {1}
                };
          }
            ...
            \path
              ...
              node[node] {M}
                ...
                child {
                  node[node] {L}
                    child[missing]
                    child {node[node] {O} edge from parent node[right] {1}}
          ...
          \newcommand\offseta{ (90:4) }
          \newcommand\offsetb{ (270:1) }
          ...
          \path
              ...
              +(0:14) node[point, label=170:{$\trm{rmv}(M)$}, label={[xshift=1em]10:{$\trm{rmv}(\epsilon)$}}] (b-rmv-m) {}
              +(0:20) node[point] (b-send-sync) {}
              +(0:24) node[point] (b-recv-sync) {}
              +(0:26) node (b-final) {};

          \initialstate{(b-initial)}{\offsetb};
          \heml{(b-ins-l)}{\offsetb};
          \hel{(b-rmv-m)}{\offsetb};
