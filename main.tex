  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
      \path
          ...
          +(0:12) node[point, label=above right:{$\set{a,b,c,e}$}, label=-170:{$\trm{add}(c)$}] (a-add-c) {}
          +(0:15) node[point, label=below left:{$\trm{sync}$}, label={[xshift=15pt]-10:{$\set{a,b,c,e}$}}] (a-sends-state) {}
      ...
      \path
          ...
          +(0:21) node (b-end) {}
          +(0:2) node[point, label=below right:{$\set{a,e}$}] (b-initial) {}
          +(0:10) node[point, label=below right:{$\set{a,d,e}$}, label=170:{$\trm{add}(d)$}] (b-add-d) {}
          +(0:15) node[point, label=170:{$\trm{sync}$}, label={[xshift=15pt]10:{$\set{a,d,e}$}}] (b-sends-state) {}
  ...
  \resizebox{\columnwidth}{!}{
    \begin{tikzpicture}
      \path
          ...
          +(0:24) node[point, label=above right:{$\set{a,b,c,d,e}$}] (a-final) {};
