...
\begin{itemize}
  ...
  \item Afin d'ordonner les modifications effectués dans un système, la littérature repose généralement sur la relation \emph{happen-before}.
  ...
  \item Lorsque modifications possibles sur un type de données sont commutatives, l'intégration des modifications effectuées par les autres noeuds, même concurrentes, ne nécessite aucun mécanisme particulier.
    Cependant, majorité des types de données proposent des opérations de modifications qui ne sont pas commutatives.
