    ...
    \begin{minipage}{\linewidth}
      ...
      \resizebox{\columnwidth}{!}{
        \begin{tikzpicture}
            \path
                node {\textbf{A}}
                to ++(0:1) node[point, label=above:{<A:1>}] (a-start) {}
                to ++(0:2) node[draw, circle, label=above:{<A:2>}] (a-a2) {a2}
                to ++(0:8) node[point, label=above:{<A:2, B:1>}, label=below:{\emph{deliver}}] (a-b1) {}
                to ++(0:3) node (a-end) {};


            \path
                to ++(270:3) node {\textbf{B}}
                to ++(0:1) node[point, label=below:{<A:1>}] (b-start) {}
                to ++(0:5) node[point, label=below:{<A:2>}, label=above:{\emph{deliver}}] (b-a2-1) {}
                to ++(0:2) node[draw, circle, label=below:{<A:2, B:1>}] (b-b1) {b1}
                to ++(0:5) node[point, label=below:{<A:2, B:1>}, label=above:{\emph{discard}}] (b-a2-2) {}
                to ++(0:1) node (b-end) {};
