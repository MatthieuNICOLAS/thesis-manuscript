...
\mnnote{TODO: Ajouter description structure des époques}
...
À la réception d'une opération, les noeuds comparent l'époque de l'opération à la leur.
...
\mnnote{TODO: Reformuler dernière phrase : si époque inconnue, pas possible d'intégrer l'opération. Doit donc ajouter une contrainte sur l'ordre de livraison des opérations : livraison basée sur époque.}
