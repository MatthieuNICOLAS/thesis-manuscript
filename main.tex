...
\begin{itemize}
  ...
  \item Lorsque modifications possibles sur un type de données sont commutatives,
    Cependant, majorité des types de données proposent des opérations de modifications qui ne sont pas commutatives.
    Ainsi, une exécution distribuée dans un système distribué suivant le paradigme de réplication optimiste peut mener à la génération d'opérations concurrentes non commutatives.
    Parle lors de conflits.
