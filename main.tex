...
La dernière contrainte spécifiée par le modèle de livraison qu'une opération doit être délivrée après l'opération \emph{rename} qui a introduite son époque de génération.
