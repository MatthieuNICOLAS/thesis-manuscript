...
\begin{itemize}
  ...
  \item Finalement,nous noterons qu'il est nécessaire pour les \acp{CRDT} synchronisés par opérations de maintenir leur journal d'opérations.
    ...
    \begin{definition}[Stabilité causale]
      ...
      Ainsi, toute opération future dépendra causalement des opérations causalement stables, \ie les noeuds ne pourront plus générer de manière honnête d'opérations concurrentes aux opérations causalement stables.
    \end{definition}
